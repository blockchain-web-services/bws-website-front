...
gh run list --status=failure --limit 1 --repo blockchain-web-services/bws-website-front

# 2. View failure logs
gh run view <run-id> --log --repo blockchain-web-services/bws-website-front | grep -i "error"
...
gh run view <run-id> --log-failed --repo blockchain-web-services/bws-website-front
```
