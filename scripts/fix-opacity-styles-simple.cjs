...
// List of marketplace component files to fix
const marketplaceFiles = [
  'marketplaceblockchainbadgesMainContent.astro',
  'marketplacedatabasemutableMainContent.astro',
  'marketplaceesgcreditsMainContent.astro',
  'marketplaceipfsuploadMainContent.astro',
  'marketplacenftgamecubeMainContent.astro',
  'marketplacenftzeroknwoledgeMainContent.astro',
  'marketplacetelegramxbotMainContent.astro'
];

console.log('Fixing opacity styles in marketplace components...');
