...
**Generated:** 2025-10-01 15:35:35 UTC
**Branch:** fix/test-failures-2025-09-28T15-58-27-e2206f4
**Commit:** b7e0c431311dd6d6d6a3f393c7d93e4e587916ad
**Workflow Run:** [View Run](https://github.com/blockchain-web-services/bws-website-front/actions/runs/18166778235)
...
**Test:** `Running 110 tests using 2 workers`
...
Running 110 tests using 2 workers
    ...
    Error: expect(locator).toBeVisible() failed
        9 × locator resolved to <img loading="lazy" data-astro-cid-pux6a34n="" class="top-menu-company-news-image" alt="Blockchain Founders Group logo" src="/assets/images/6474d385cfec71cb21a9229a/6505cc39f53261fa63453cc8_logo-blockchain-founders-group-background-transparent.svg"/>
          - unexpected value "hidden"
      99 |       console.error('❌ No BFG images found in DOM');
        at /home/runner/work/bws-website-front/bws-website-front/tests/assets.spec.js:96:25
    test-results/assets-Asset-Verification--05590-n-Founders-Group-image-test-chromium/test-failed-1.png
    test-results/assets-Asset-Verification--05590-n-Founders-Group-image-test-chromium/video.webm
    ...
    test-results/assets-Asset-Verification--05590-n-Founders-Group-image-test-chromium-retry1/video.webm
