...
**Generated:** 2025-10-02 09:22:30 UTC
**Branch:** fix/test-failures-2025-09-28T15-58-27-e2206f4
**Commit:** 16266f587aa795eb4124c503946da9cc2dfeba16
**Workflow Run:** [View Run](https://github.com/blockchain-web-services/bws-website-front/actions/runs/18188385879)
...
**Test:** `e2e-navigation-Navigation-Tests-Footer-navigation-links-work`
...
**Test:** `e2e-navigation-Navigation--919e3-o-click-returns-to-homepage`

**Error Details:**
```
Error: expect(received).toBeTruthy()
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:46:22
    Error: expect(received).toBeTruthy()
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:46:22
```
...
**Test:** `    Error: expect(received).toBeTruthy()`

**Error Details:**
```
Error: styles.css not found in _site directory
    > 60 |       throw new Error('styles.css not found in _site directory');
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:60:13
    Error: styles.css not found in _site directory
```
...
Running 110 tests using 2 workers
    ...
    TimeoutError: page.waitForLoadState: Timeout 60000ms exceeded.
       at page-objects/BasePage.js:31
        at HomePage.waitForPageLoad (/home/runner/work/bws-website-front/bws-website-front/tests/page-objects/BasePage.js:31:21)
        at HomePage.navigateTo (/home/runner/work/bws-website-front/bws-website-front/tests/page-objects/BasePage.js:24:16)
        at HomePage.goto (/home/runner/work/bws-website-front/bws-website-front/tests/page-objects/HomePage.js:45:5)
        at /home/runner/work/bws-website-front/bws-website-front/tests/e2e/navigation.spec.js:50:5
    ...
    TimeoutError: locator.click: Timeout 30000ms exceeded.
       at page-objects/BasePage.js:109
        at HomePage.navigateViaMenu (/home/runner/work/bws-website-front/bws-website-front/tests/page-objects/BasePage.js:109:68)
    ...
    Error: expect(page).toHaveURL(expected) failed
        ...
        at /home/runner/work/bws-website-front/bws-website-front/tests/e2e/navigation.spec.js:90:26
    ...
    TimeoutError: locator.click: Timeout 30000ms exceeded.
        at /home/runner/work/bws-website-front/bws-website-front/tests/e2e/navigation.spec.js:77:59
    ...
    Error: expect(received).toBeTruthy()
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:46:22
    test-results/image-validation-Image-Fil-defd4-es-exist-in-build-directory-chromium-retry1/trace.zip
        npx playwright show-trace test-results/image-validation-Image-Fil-defd4-es-exist-in-build-directory-chromium-retry1/trace.zip
    Error: expect(received).toBeTruthy()
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:46:22
    Error: styles.css not found in _site directory
    > 60 |       throw new Error('styles.css not found in _site directory');
    ...
    > 60 |       throw new Error('styles.css not found in _site directory');
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:60:13
    test-results/image-validation-Image-Fil-598ee-e-defined-with-proper-rules-chromium-retry1/trace.zip
        npx playwright show-trace test-results/image-validation-Image-Fil-598ee-e-defined-with-proper-rules-chromium-retry1/trace.zip
    Error: styles.css not found in _site directory
    > 60 |       throw new Error('styles.css not found in _site directory');
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:60:13
    Error: index.html not found in _site directory
    > 101 |       throw new Error('index.html not found in _site directory');
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:101:13
    Error: index.html not found in _site directory
    > 101 |       throw new Error('index.html not found in _site directory');
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:101:13
    ...
    Error: expect(received).toBeLessThanOrEqual(expected)
      220 |           const expectedWidth = parseInt(image.maxWidth.replace('px', ''));
    > 222 |           expect(actualWidth).toBeLessThanOrEqual(expectedWidth);
        at /home/runner/work/bws-website-front/bws-website-front/tests/image-validation.spec.js:222:31
