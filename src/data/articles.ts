...
export const articles: ArticleMetadata[] = [
{
  ...
  subtitle: 'Managing crypto community engagement across X and Telegram requires real-time data and bot detection capabilities. X Bot delivers automated KOL monitoring, authentic engagement metrics, and daily performance reports through official X API integration, helping verifiable credentials projects identify genuine influence and community growth.',
...
},
{
  ...
  tweetId: '',
  featuredImage: {
    src: '/assets/images/docs/verifiable credentials-badges/badges-0.png',
    alt: 'Cover',
    loading: 'eager'
  },
...
{
  slug: 'badges-2025-12-26',
  product: 'Badges.ninja',
  title: 'Badges.ninja: Issue Tamper-Proof Digital Credentials at Scale',
  subtitle: 'Credential fraud costs organizations billions annually while traditional verification systems remain slow and unreliable. Badges.ninja creates immutable digital credentials with cross-platform verification, enabling institutions to issue tamper-proof certificates that can be instantly verified on the verifiable credentials.',
