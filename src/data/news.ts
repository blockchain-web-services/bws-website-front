...
export const newsItems: NewsItem[] = [
  {
    title: 'Quick Sync',
    description: 'Quick Sync integrates BWS\'s X Bot to enhance their data sharing infrastructure and Web3 API capabilities',
  ...
  {
    title: 'Rouge Studio',
    description: 'Rouge Studio integrates BWS\'s X Bot technology to enhance community engagement and performance tracking in Web3',
